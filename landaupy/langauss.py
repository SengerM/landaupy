...
def pdf_not_vectorized(x: float, mu: float, eta: float, sigma: float) -> float:
	"""Non vectorized langaus PDF calculation. This function should be avoided, this is almost a copy-paste from the original Root code in https://root.cern.ch/doc/master/langaus_8C.html only for testing purposes."""
